...
<head>
    ...
    <meta name="description" content="Create your <?= htmlspecialchars($siteName) ?> account - Free premium image hosting">
...
<body class="min-h-screen font-sans overflow-x-hidden">
    ...
    <div id="bg-container" class="fixed inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div id="blob-1" class="blob blob-purple"></div>
        <div id="blob-2" class="blob blob-cyan"></div>
        <div id="blob-3" class="blob blob-pink"></div>
    </div>

    <!-- Main Content -->
    <main class="relative z-10 min-h-screen flex items-center justify-center p-4 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                <a href="/" class="inline-flex items-center gap-3 mb-4">
                    ...
                    <span class="text-2xl font-bold text-gradient-purple"><?= htmlspecialchars($siteName) ?></span>
                </a>
                <h1 class="text-xl font-semibold text-[var(--color-text-primary)]">Create your account</h1>
                <p class="text-sm text-[var(--color-text-tertiary)] mt-1">Start hosting your images for free</p>
            </div>
            ...
            <div class="auth-card">
                ...
                <form id="registerForm" class="space-y-5" novalidate>
                    ...
                    <div class="auth-field">
                        ...
                        <p class="auth-field-hint">We'll never share your email</p>
                    </div>
                    ...
                    <div class="auth-field">
                        ...
                        <div class="password-strength mt-2">
                            ...
                            <span class="strength-text text-xs text-[var(--color-text-muted)]" id="strengthText"></span>
                        </div>

                        <ul class="auth-password-requirements mt-2">
                            <li id="req-length"><i data-lucide="circle" class="w-3 h-3"></i> At least 8 characters</li>
                            <li id="req-upper"><i data-lucide="circle" class="w-3 h-3"></i> One uppercase letter</li>
                            <li id="req-lower"><i data-lucide="circle" class="w-3 h-3"></i> One lowercase letter</li>
                            <li id="req-number"><i data-lucide="circle" class="w-3 h-3"></i> One number</li>
                        </ul>
                    </div>
                    ...
                    <div class="auth-field">
                        ...
                        <div class="auth-input-wrapper">
                            ...
                            <input
                                ...
                                required
                            >
                            <button type="button" class="auth-toggle-password" onclick="togglePassword('confirm_password')">
                                <i data-lucide="eye" class="w-4 h-4"></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <label class="auth-checkbox">
                        ...
                        <span class="text-sm text-[var(--color-text-secondary)]">
                            I agree to the <a href="/terms" class="text-neon-cyan hover:underline">Terms of Service</a>
                            and <a href="/privacy" class="text-neon-cyan hover:underline">Privacy Policy</a>
                        </span>
                    </label>
                ...
                <!-- Social Login -->
                <div class="flex justify-center">
                    <a href="/auth/google" class="inline-flex items-center gap-3 px-6 py-3 bg-white/10 hover:bg-white/20 rounded-xl text-[var(--color-text-primary)] font-medium transition-all hover:-translate-y-0.5">
                ...
                <p class="text-center text-sm text-[var(--color-text-secondary)]">
                    ...
                    <a href="/login" class="text-neon-purple hover:underline font-medium">Sign in</a>
                </p>
            </div>
    ...
    <script>
        ...
        function checkPasswordStrength() {
            ...
            strength = Math.min(4, Math.ceil(strength * 4 / 6));
